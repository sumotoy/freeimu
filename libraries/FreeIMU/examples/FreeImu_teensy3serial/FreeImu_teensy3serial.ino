  ...
  if(Serial.available()) {
    ...
    if(cmd=='v') {
      ...
      for(uint8_t i=0; i<count; i++) {
        ...
        #else // MPU6050
         my3IMU.accgyro.getMotion6(((int16_t*)(&raw_values[0])),((int16_t*)(&raw_values[1])),((int16_t*)(&raw_values[2])),((int16_t*)(&raw_values[3])),((int16_t*)(&raw_values[4])),((int16_t*)(&raw_values[5])));
